...
final getAllPhonesUsecaseProvider = Provider<GetAllPhonesUsecase>((ref) {
  final phoneRepository = ref.read(phoneRepositoryProvider);
  return GetAllPhonesUsecase(phoneRepository: phoneRepository);
});

class GetAllPhonesUsecase implements UsecaseWithoutParams<List<PhoneEntity>> {
  final IPhoneRepository _phoneRepository;

  GetAllPhonesUsecase({required IPhoneRepository phoneRepository})
